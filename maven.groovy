...
def call(){
  ...
  stage("Paso 7: Descargar Nexus"){
      sh ' curl -X GET -u $NEXUS_USER:$NEXUS_PASS "http://nexus3:8081/repository/devops-usach-nexus/com/devopsusach2020/DevOpsUsach2020/0.0.1/DevOpsUsach2020-0.0.1.jar" -O'
  }
